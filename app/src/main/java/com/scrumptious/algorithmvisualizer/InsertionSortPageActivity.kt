...
import com.scrumptious.algorithmvisualizer.databinding.ActivityInsertionSortPageBinding
class InsertionSortPageActivity: AppCompatActivity() {

    //Activity link to algorithm page
    private lateinit var binding: ActivityInsertionSortPageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.start.setOnClickListener{
            ...
            datavalidator_instance.validate(binding.dataInput.text.toString())
            // check data status
            ...
            if(datavalidator_instance.dataStatus == "Input is valid and sorted"){
                ...
                val myList: MutableList<Pair<Array<Int>, Array<Int>>> = seqGen.buildSequence(InsertionSort(),datavalidator_instance.validData.toTypedArray())// your data here
